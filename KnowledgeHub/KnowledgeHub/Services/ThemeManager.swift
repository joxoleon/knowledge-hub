...
class ThemeManager: ObservableObject {
    ...
    @Published var backgroundColor: Color = .background_3
    @Published var textColor: Color = .text_color_1
    @Published var codeBackgroundColor: Color = .codeBackgroundColor_1
...
extension Color {
    ...
    static let codeBackgroundColor_1 = Color("code-background-1")
